...
<style>
  ...
  .reveal ul, .reveal ol { box-sizing: border-box; max-width: 100%; padding-left: 1.1em; }
  .reveal section > ul, .reveal section > ol { margin-left: 0; }
  ...
  /* Download-PDF link, lower-left (hidden during PDF export so it isn't captured in the PDF). */
  .pdf-link { position: fixed; bottom: 12px; left: 16px; z-index: 40; font-size: 11pt; color: #9aa0a8; text-decoration: none; }
  .pdf-link:hover { color: #2166ac; }
  .exporting .pdf-link { display: none; }
</style>
</head>
<body>
<div class="deck">
...
<a class="pdf-link" href="talk.pdf" download="academic-ledger-talk.pdf">⬇ Download PDF</a>
</div>
<script>if (new URLSearchParams(location.search).has("export")) document.documentElement.classList.add("exporting");</script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/reveal.js/5.1.0/reveal.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/reveal.js/5.1.0/plugin/notes/notes.min.js"></script>
<script>
  Reveal.initialize({ hash: true, slideNumber: "c/t", width: 1280, height: 720, margin: 0.025, plugins: [ RevealNotes ] });
</script>
</body>
</html>
"""
